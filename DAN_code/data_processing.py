...
def prepare_flat_data(dataset, normalize_data = True, softening = None):
    ...
    #prior_y = counts_y / np.sum(counts_y)
    ...
    if softening is not None:
        ...
        #y_train = (1 - softening) * y_train + softening * (1 - softening / (y_train.shape[1] + 1)) * prior_y
    
    return x_train, y_train, x_test, y_test

def prepare_patch_data(dataset, normalize_data = True, softening = None):
